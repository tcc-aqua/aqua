            ...
            <Card className="bg-white border-2 border-slate-200 shadow-lg">
              <CardContent className="p-8">
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-slate-900 mb-2">O Problema</h3>
                ...
                <div className="space-y-6">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-slate-700">São Paulo, SP - Zona Sul</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <UsersIcon className="w-5 h-5 text-slate-400" />
                    <span className="text-slate-700">240 famílias • 960 pessoas</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CalendarIcon className="w-5 h-5 text-slate-400" />
                    <span className="text-slate-700">Implementação: Janeiro 2024</span>
                  </div>
                </div>
                ...
                <div className="mt-8 pt-6 border-t border-slate-200">
                  ...
                  <div className="mt-4 flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-medium text-slate-900">Miguel Andrade</div>
                      <div className="text-sm text-slate-600">Síndico, Nova Aurora</div>
                    </div>
                  </div>
                </div>
              </CardContent>
