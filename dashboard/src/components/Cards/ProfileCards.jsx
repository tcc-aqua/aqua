      ...
      <main className="container mx-auto ">
        <section className="grid grid-cols-1 md:grid-cols-2 gap-6 p-4">
          <AnimationWrapper delay={0.1}>
            ...
            <Card className="bg-card rounded-md shadow-md h-auto  hover:border-sky-400 dark:hover:border-sky-600">
              <CardHeader>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-6 p-4 ">
          ...
          <AnimationWrapper delay={0.2} >
            <Card className="bg-card rounded-md shadow-md h-auto md:h-131  md:-mt-27  hover:border-sky-400 dark:hover:border-sky-600 ">
              <CardHeader>
                <CardTitle className="text-sm font-semibold flex items-center gap-2">
