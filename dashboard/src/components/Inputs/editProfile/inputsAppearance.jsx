...
export default function InputAppearance() {
  ...
  return (
    <div className="mx-auto max-w-lg  space-y-4">
      ...
      <Card className="shadow-md hover:shadow-lg transition-shadow   hover:border-sky-400 dark:hover:border-sky-600">
      ...
      <Card className="shadow-md hover:shadow-lg transition-shadow mt-3  hover:border-sky-400 dark:hover:border-sky-600">
        <CardContent className="flex justify-between items-center">
          <div className="flex flex-col">
            <p className="text-sm font-semibold flex items-center gap-2">
